...
router.post('/', async (req, res) => {
  ...
  try {
    ...
    const campanha = await client.query(
      `INSERT INTO campaigns (company_id, product_id, budget_cents, duration_days, audience, region, objective)
       VALUES ($1,$2,$3,$4,$5,$6,$7) RETURNING *`,
      [company_id, product_id, budgetCents, duration_days || 7, audience || null, region || 'Brasil', objective || 'vendas']
    );
